...
gt = read.table('sirpa-mutant-genotypes.tsv',sep='\t',header=TRUE)
...
plot_order = 5:9 # which columns to plot, and in what order
display_names = colnames(gt)
display_names[plot_order] = c("C57BL/6J reference","Sirpa WT","Sirpa het","Sirpa mut","129 reference")
...
png('sirpa-mice-genotypes.png',width=1000,height=500)
